...
p(b.detail):(a(l.responseText),b=JSON.parse(l.responseText),s(b))},!1);if(void 0!==e)for(var q in e)l.setRequestHeader(q,e[q]);l.setRequestHeader("Accept","application/json; charset\x3dutf-8");l.send(h)}}}var k=h.console,d=h.CAGE||{};d.ajax=d.ajax||{};d.ajax={GET:function(a){a.method="GET";f(a)},POST:function(a){a.method="POST";a.headers={"Content-Type":"application/x-www-form-urlencoded"};f(a)},PUT:function(a){a.method="PUT";a.headers={"Content-Type":"application/x-www-form-urlencoded"};f(a)},DELETE:function(a){a.method=
"DELETE";f(a)}};"undefined"!==typeof module&&module.exports?module.exports=d:h.CAGE=d})(this);
